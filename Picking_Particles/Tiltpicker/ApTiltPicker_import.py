...
class PickerApp(wx.App):
	def __init__(self, mode='default',
	 ...
	 tiltangle=None, tiltaxis=None, 
	 picks1="picks1", picks2="picks2",outfileout="outfile",doinit=True):
		self.mode = mode
		...
		self.picks1=numpy.genfromtxt(picks1,delimiter="\t")
		self.picks2=numpy.genfromtxt(picks2,delimiter="\t")
		self.outfileout=outfileout
	...
	def OnInit(self):
		...
		self.data['outfile'] = self.outfileout
		self.data['dirname'] = ""
		...
		#self.picks1 = numpy.genfromtxt("14mar28y_14mar28z_14mar27y_13feb14w_12aug01q_008u_dc4_convert_2cols.spi",delimiter="\t") 
		#self.picks2 = numpy.genfromtxt("14mar28y_14mar28z_14mar27y_13feb14w_12aug01q_008t_dc4_convert_2cols.spi",delimiter="\t")
...
if __name__ == '__main__':
	...
	parser.add_option("--picks1", dest="picks1", 
                help="Spider picks file for left image", metavar="FILE")
	parser.add_option("--picks2", dest="picks2", 
                help="Spider picks file for right image", metavar="FILE")
	parser.add_option("--outputfile", dest="outfile", 
                help="Output spider text file", metavar="FILE")
	...
	app = PickerApp(
		...
		picks1=params['picks1'],picks2=params['picks2'],outfileout=params['outfile']
	)
